        ...
        eventTrigger: function (t, e) {
          for (var n = 0; n < a.events.length; n++) {
            ...
            if (o.name == t) {
              ...
              if (0 == o.fired)
                return (a.events[n].fired = !0), o.handler.call(this, a, e);
            }
          }
        },
        addEvent: function (t, e, n) {
        ...
        eventTrigger: function (t, e, n) {
          for (var o = 0; o < a.events.length; o++) {
            ...
            if (i.name == t) {
              ...
              if (0 == i.fired)
                return (a.events[o].fired = !0), i.handler.call(this, e, n);
            }
          }
        },
        addEvent: function (t, e, n) {
          ...
          if (a.options.toggleBy)
            if ("string" == typeof a.options.toggleBy)
              ...
              a.options.toggleBy &&
                ...
                KTUtil.addEvent(a.options.toggleBy.target, "click", function (
                  t
                ) {
                  t.preventDefault(), l.toggle();
                });
  ...
  return {
    ...
    get: function (t) {
      ...
      return t === document
        ...
        ? e
        : (e = document.getElementsByTagName(t)).length > 0
        ? e[0]
        : (e = document.getElementsByClassName(t)).length > 0
        ? e[0]
        : null;
    },
    getByID: function (t) {
        ...
        if (t.classList)
          ...
          for (var o = 0; o < a.length; o++)
            t.className = t.className.replace(
              new RegExp("\\b" + KTUtil.trim(a[o]) + "\\b", "g"),
              ""
            );
      }
    },
    ...
    data: function (t) {
      return (
        (t = KTUtil.get(t)),
        {
          ...
          get: function (e) {
            if (void 0 !== t)
              return null == t || void 0 === t.customDataTag
                ? null
                : this.has(e)
    ...
    var o = { startStep: 1, clickableSteps: !0 },
      i = {
        ...
        goTo: function (t, e) {
          if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
            ...
            if (
              ...
              return (
                !1 !== n &&
                  (!0 === e && i.eventTrigger("beforeChange"),
                  (a.currentStep = t),
                  i.updateUI(),
                  !0 === e && i.eventTrigger("change")),
                !0 === e
                  ? t > a.startStep
        ...
        updateUI: function () {
          var t = "",
            e = a.currentStep - 1;
          (t = i.isLastStep() ? "last" : i.isFirstStep() ? "first" : "between"),
        ...
        eventTrigger: function (t, e) {
          for (var n = 0; n < a.events.length; n++) {
            ...
            if (o.name == t) {
              ...
              if (0 == o.fired)
                return (a.events[n].fired = !0), o.handler.call(this, a);
            }
          }
        },
        addEvent: function (t, e, n) {
      ...
      if (0 !== t(this).length) {
        ...
        var l = {
            ...
            null === e.data.source && (l.extractTable(), (n = !0)),
              ...
              ("remote" !== e.data.type && "local" !== e.data.type) ||
                ...
                "local" === e.data.type &&
                  ...
                  (i.dataSet = i.originalDataSet = l.dataMapCallback(
                    e.data.source
                  )),
                l.dataRender()),
              n &&
                      ...
                      t(this).ready(function () {
                        !(function (a) {
                          if (t(a).find(".kt-datatable__lock").length > 0)
                            ...
                            0 !== t(a).find(".kt-datatable__row").length
                          ) {
          ...
          initHeight: function () {
            if (o.layout.height && o.layout.scroll) {
              ...
              e > 0 && (n -= e),
                a > 0 && (n -= a),
                (n -= 2),
                t(i.tableBody).css("max-height", Math.floor(parseFloat(n)));
            }
          },
                    ...
                    .each(function (a, n) {
                      ...
                      if (void 0 !== o) {
                        ...
                        if (void 0 !== o.selector && !1 !== o.selector) {
                          if (
                            t(n).find('.kt-checkbox [type="checkbox"]').length >
                            0
                          )
                            return;
                        ...
                        if (void 0 !== o.subtable && o.subtable) {
                          if (
                            t(n).find(".kt-datatable__toggle-subtable").length >
                            0
                          )
                            return;
                          t(n)
          ...
          dataRender: function (e) {
            ...
            var a = function () {
              ...
              n = function (e) {
                ...
                if (
                  (t(i.wrap).removeClass("kt-datatable--error"), o.pagination)
                )
          ...
          updateTableComponents: function () {
            (i.tableHead = t(i.table).children("thead").get(0)),
              (i.tableBody = t(i.table).children("tbody").get(0)),
              (i.tableFoot = t(i.table).children("tfoot").get(0));
          },
          getData: function () {
            var e = {
              dataType: "json",
          ...
          columnHide: function () {
            ...
            t.each(o.columns, function (n, o) {
              if (void 0 !== o.responsive || void 0 !== o.visible) {
                var r = o.field,
                  s = t.grep(t(i.table).find(".kt-datatable__cell"), function (
                    e,
                    a
                  ) {
                ...
                setTimeout(function () {
                  !1 === l.getObject("visible", o)
                    ? t(s).hide()
                    : (a.getBreakpoint(l.getObject("responsive.hidden", o)) >= e
                        ? t(s).hide()
                        : t(s).show(),
                      a.getBreakpoint(l.getObject("responsive.visible", o)) <= e
                        ? t(s).show()
                        : t(s).hide());
                });
              }
                  ...
                  t(n).hasClass("kt-datatable__row--subtable-expanded")
                    ...
                    0 === t(s).find(".kt-datatable").length &&
                      (t.map(i.dataSet, function (t, e) {
                        return (
                          d === t[o.columns[0].field] && ((a.data = t), !0)
                        );
                      }),
                      (a.detailCell = s),
                      (a.parentRow = n),
                    ...
                    .each(function (e, o) {
                      ...
                      if (void 0 !== i) {
                        ...
                        if (void 0 !== i.subtable && i.subtable) {
                          if (
                            t(o).find(".kt-datatable__toggle-subtable").length >
                            0
                          )
                            return;
                          t(o).html(
              ...
              t(i.table).find(".kt-datatable__cell").show(),
                ...
                e &&
                  t(i.tableBody)
                    ...
                    .each(function () {
                      0 ===
                        t(this).find(".kt-datatable__toggle-detail").length &&
                        t(this).prepend(
                          t("<td/>")
                            .addClass(
                        ...
                        0 ===
                        t(i.tableHead).find(".kt-datatable__toggle-detail")
                          .length
                          ? (t(i.tableHead)
                              .find(".kt-datatable__row")
                              .first()
          ...
          getTableId: function (e) {
            ...
            var a = t(i).attr("id");
            return (
              void 0 === a && (a = t(i).attr("class").split(" ")[0]), a + e
            );
          },
              ...
              setIcon: function () {
                ...
                if (!t.isEmptyObject(e)) {
                  ...
                  if (
                    ...
                    var n = t(i.tableHead)
                        .find(
                          '.kt-datatable__cell[data-field="' + e.field + '"]'
                        )
              ...
              t(i.tableBody)
                ...
                .each(function (a, n) {
                  if (e == t(n).text()) {
                    ...
                    return (
                      (i.API.record = i.API.value = l.getOneRow(
                        i.tableBody,
                        o
                      )),
                      i
          ...
          setSelectedRecords: function () {
            return (
              (i.API.record = t(i.tableBody).find(
            ...
            void 0 !== a && (a = t.makeArray(a)),
              (n = function () {
                ...
                "object" == typeof a &&
                  ...
                  i.setDataSourceParam(
                    "pagination",
                    Object.assign({}, i.getDataSourceParam("pagination"), {
                      page: 1,
                    })
                  ),
                  o.data.serverFiltering || l.localDataUpdate(),
          ...
          row: function (e) {
            return (
              l.rows(e), (l.nodeTr = l.recentNode = t(l.nodeTr).first()), i
            );
          },
          rows: function (e) {
            return (
              l.isLocked()
                ? (l.nodeTr = l.recentNode = t(i.tableBody)
                    .find(e)
          ...
          column: function (e) {
            return (
              (l.nodeCols = l.recentNode = t(i.tableBody).find(
          ...
          cell: function (e) {
            return (
              l.cells(e), (l.nodeTd = l.recentNode = t(l.nodeTd).first()), i
            );
          },
          cells: function (e) {
          ...
          visible: function (e) {
            if (t(l.recentNode.length)) {
              ...
              if (l.recentNode === l.nodeCols) {
                ...
                if (l.isLocked()) {
                  var i = t(l.recentNode).closest(".kt-datatable__lock--scroll")
                    .length;
                  i
                    ? (n += a.left.length + 1)
              ...
              e
                ? (l.recentNode === l.nodeCols && delete o.columns[n].visible,
                  t(l.recentNode).show())
        ...
        sticky: {
          ...
          position: {
            ...
            right: function (t) {
              ...
              return (
                parseInt(KTUtil.css(KTUtil.get("body"), "width")) -
                a -
    ...
    initAside: function () {
      ...
      (s = KTUtil.get("kt_aside")),
        ...
        KTUtil.get("kt_aside_toggler") &&
          ((i = new KTToggle("kt_aside_toggler", {
            target: "body",
