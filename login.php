...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row d-flex justify-content-center">
                  <div class="card col-md-6 p-0 formcenter">
                    <div class="card-body py-4 centerverti">
                    
                    
                    
                    <form class="" action="" method="post">
                    
                    <div class="card-header py-4 bg-transparent border-bottom loginlogo">
                      <img src="assets/images/logo-icon.png" alt="" class="mr-2">
	...
	<div id="validationServer03" class="inputGroup inputGroup1 is-invalid">
		<label for="email1">Username</label>
		<input type="text" id="email" name="username" required class="email" maxlength="256" autocomplete="off"/>
		<p class="helper helper1">Enter Username</p>
  ...
  <?php if (isset($_SESSION['MESSAGE'])): ?>
                            <div class="alert alert-primary alert-dismissible fade show rounded-0">
                              <span><?= $_SESSION['MESSAGE'] ?></span>
                            </div>
                          <?php endif; ?>
		<button id="_login" type="submit" name="login">Log in</button>
	</div>	
</form>
                    </div>
                  </div>
